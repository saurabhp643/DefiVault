...
const config: HardhatUserConfig = {
  solidity: {
    ...
    settings: {
      optimizer: {
        enabled: true,
        runs: 800, // Increased from 200 to reduce deployment size
      },
  ...
  networks: {
    ...
    localhost: {
      ...
      gas: 'auto', // Let Hardhat auto-detect gas limit
    },
    hardhat: {
        forking: {
          url: "https://eth-mainnet.g.alchemy.com/v2/ipt6875EFYV7HNNFMycMQ",
          blockNumber: 20000000 // optional: fix block for reproducibility
        },
        // Disable EDR
